...
const areas = [
  "Manchester", "Droylsden", "Tameside", "Oldham", "Ashton-under-Lyne",
  "Hyde", "Denton", "Stockport", "Trafford", "Salford", "Bolton", "Wigan",
  "Glossop", "Rochdale", "Bury", "Preston", "Blackburn", "Leeds"
];
